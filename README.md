...
```bash
git clone https://github.com/Endless-Lemniscate/Codex-Security-Auditor-Plugin.git
cd Codex-Security-Auditor-Plugin
```

Use it as a local Codex plugin by registering this directory in your Codex plugin marketplace/configuration, or by copying the plugin directory into the local plugin location used by your Codex setup.
